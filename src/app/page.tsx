...
// Browser-only — GSAP + cursor APIs, never SSR
...
const stagger = (delay = 0, gap = 0.08) => ({
    ...
    <>
      ...
      >
            ...
            <div className="hidden md:flex items-center gap-6 text-xs" style={{ color: "rgba(255,255,255,0.4)" }}>
              {["Features", "Preview", "Pricing"].map(l => (
                <a key={l} href={`#${l.toLowerCase()}`}
                  className="transition-colors duration-200 hover:text-white">{l}</a>
              ))}
            </div>
            <div className="flex items-center gap-3">
              <Link href="/login"
                className="text-xs transition-colors duration-200 font-medium px-3 py-1.5"
                style={{ color: "rgba(255,255,255,0.4)" }}>
                Log in
              </Link>
              <Link href="/pricing"
                className="inline-flex items-center gap-1.5 rounded-lg px-4 py-1.5 text-xs font-bold transition-all duration-200 hover:brightness-110"
        ...
        <section className="relative px-5 overflow-hidden" style={{ paddingTop: "clamp(5rem,12vh,8rem)", paddingBottom: "clamp(4rem,10vh,7rem)" }}>
          ...
          >
            ...
            <motion.div variants={up} className="flex flex-wrap items-center justify-center gap-3 mb-6">
              <Link href="/login"
                className="inline-flex items-center gap-2 rounded-xl px-8 py-3.5 text-sm font-bold transition-all duration-200 hover:brightness-110 hover:scale-[1.02]"
                style={{ background: G, color: "#000", boxShadow: `0 0 40px rgba(201,168,85,0.3)` }}>
                <Zap className="h-4 w-4" /> Start for Free
              </Link>
              <Link href="/dashboard"
                className="inline-flex items-center gap-2 rounded-xl border px-8 py-3.5 text-sm font-semibold transition-colors duration-200 hover:bg-white/5"
        ...
        <div style={{ borderTop: "1px solid rgba(201,168,85,0.08)", borderBottom: "1px solid rgba(201,168,85,0.08)", background: S1 }}>
          <motion.div className="max-w-4xl mx-auto px-5 py-6 grid grid-cols-2 md:grid-cols-4"
        ...
        <section id="preview" className="py-24 px-5" style={{ background: BG }}>
          <div className="max-w-6xl mx-auto">
            <motion.div className="text-center mb-14" variants={stagger()} initial="hidden" whileInView="show" viewport={vp}>
            ...
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0, transition: { duration: 0.5, ease: E } }} viewport={vp}>
              <TerminalPreview />
            </motion.div>
          </div>
        </section>
        ...
        <section id="features" className="py-24 px-5" style={{ background: S1 }}>
          <div className="max-w-6xl mx-auto">
            ...
            <motion.div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"
              variants={stagger(0.05, 0.05)} initial="hidden" whileInView="show" viewport={vp}>
              {FEATURES.map(f => (
                <motion.div key={f.title} variants={up}
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="inline-flex items-center justify-center w-10 h-10 rounded-xl"
                      style={{ background: `rgba(${hexToRgb(f.accent)},0.1)`, border: `1px solid rgba(${hexToRgb(f.accent)},0.18)`, color: f.accent }}>
                      {f.icon}
                    </div>
            ...
            <motion.div className="mt-8 rounded-2xl p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-5"
              style={{ background: S2, border: "1px solid rgba(255,255,255,0.05)" }}
              initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0, transition: { duration: 0.4, ease: E } }} viewport={vp}>
              <div>
              ...
              <Link href="/login"
                className="shrink-0 inline-flex items-center gap-1.5 rounded-xl border px-5 py-2.5 text-sm font-semibold transition-colors duration-200 hover:bg-white/5 whitespace-nowrap"
        ...
        <section className="py-24 px-5" style={{ background: BG }}>
          <div className="max-w-5xl mx-auto">
            ...
            <motion.div className="grid grid-cols-1 md:grid-cols-3 gap-5"
              variants={stagger(0, 0.1)} initial="hidden" whileInView="show" viewport={vp}>
              {TESTIMONIALS.map(t => (
        ...
        <section id="pricing" className="py-24 px-5" style={{ background: S1 }}>
          <div className="max-w-5xl mx-auto">
            ...
            <motion.div className="grid grid-cols-1 md:grid-cols-3 gap-5"
              ...
              {/* Free */}
              <motion.div variants={up} className="rounded-2xl p-7 flex flex-col"
                ...
                <Link href="/login"
                  className="flex items-center justify-center w-full rounded-xl border py-3 text-sm font-semibold transition-colors duration-200 hover:bg-white/5"
              ...
              {/* Pro Monthly */}
              <motion.div variants={up} className="rounded-2xl p-7 relative flex flex-col"
                ...
                <Link href="/pricing?billing=monthly"
                  className="flex items-center justify-center gap-2 w-full rounded-xl py-3 text-sm font-bold transition-all duration-200 hover:brightness-110"
                  style={{ background: G, color: "#000" }}>
        ...
        <section className="py-28 px-5 relative overflow-hidden" style={{ background: BG }}>
          ...
          <motion.div className="relative max-w-3xl mx-auto text-center"
            variants={stagger(0, 0.08)} initial="hidden" whileInView="show" viewport={vp}>
            <motion.div variants={up}
        ...
        <footer style={{ borderTop: "1px solid rgba(201,168,85,0.07)" }} className="py-8 px-5">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6 text-xs" style={{ color: "rgba(255,255,255,0.25)" }}>
              {[{ href: "/privacy", label: "Privacy Policy" }, { href: "/about", label: "About" }, { href: "/login", label: "Login" }].map(l => (
                <Link key={l.label} href={l.href} className="transition-colors duration-200 hover:text-white">{l.label}</Link>
              ))}
              <a href="mailto:tradex.edgefx@gmail.com" className="transition-colors duration-200 hover:text-white">Contact</a>
            </div>
