        ...
        <CardContent>
          <SettingRow label="Theme" description="Terminal color scheme  -  previewed live, saved on click Save">
            <SegmentedPills<Theme>
              options={["dark", "midnight", "oled", "codgray", "royalcharcoal", "pink", "light"]}
              value={draft.theme}
              onChange={(v) => update("theme", v)}
              labels={{ dark: "Dark", midnight: "Midnight", oled: "OLED", codgray: "Cod Gray", royalcharcoal: "Royal Charcoal", pink: "Pink", light: "Light" }}
            />
          </SettingRow>
