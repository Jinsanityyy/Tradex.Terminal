...
const FALLBACK_CATALYSTS: Catalyst[] = [
  ...
  },
  {
    ...
    marketImplication: "CPI beat = gold-negative. CPI miss = strongly gold-positive.",
    sentimentTag: "neutral",
  ...
  },
  {
    ...
    marketImplication: "Strong NFP = gold-negative. Weak NFP = gold-positive. The 30-min retest is the cleaner read.",
    sentimentTag: "neutral",
    driverCategory: "MACRO DATA",
  ...
  },
  {
    ...
    marketImplication: "Trade escalation = gold-positive. Trade deal progress = risk-on, gold-negative.",
    sentimentTag: "bearish",
    driverCategory: "TRADE",
    keyPoints: ["Tariff escalation triggers risk-off safe-haven flows into gold", "Every new tariff headline adds a geopolitical risk premium to spot prices", "A trade deal or de-escalation would flip the read — risk-on, gold-negative"],
